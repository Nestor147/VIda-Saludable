# Generated by Django 5.0.7 on 2024-09-10 22:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desayuno_saludable', models.BooleanField(blank=True, default=False, null=True)),
                ('almuerzo_saludable', models.BooleanField(blank=True, default=False, null=True)),
                ('cena_saludable', models.BooleanField(blank=True, default=False, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.usuario')),
            ],
        ),
        migrations.CreateModel(
